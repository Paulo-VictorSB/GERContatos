...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    // check if there is another with the same number
    $params = [
        'id' => $id,
        ':telefone' => $telefone
    ];
        ...
        <div class="card p-4">
            ...
            <form action="editar_contato.php?id=<?=$id?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="text_telefone" id="text_telefone" class="form-control" minlength="3" maxlength="12" required value="<?=$contact->telefone?>">
                </div>
