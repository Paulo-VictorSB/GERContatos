...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    if($results->affected_rows != 0){
        ...
        $results = $database->execute_query("INSERT INTO contactos VALUES(0, :nome, :telefone, NOW(), NOW())", $params);
        ...
        <div class="card p-4">
            ...
            <form action="adicionar_contato.php" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="text_telefone" id="text_telefone" class="form-control" minlength="3" maxlength="12" required>
                </div>
